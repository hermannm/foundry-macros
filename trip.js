...
(async () => {
    ...
    const skillRollWithMAP = (penalty) => {
        ...
        new Dialog({
            ...
            buttons: {
                ...
                second: {
                    label: "2nd attack",
                    callback: () => {
                        skillRollWithMAP(action.multipleAttackPenalty === "agile" ? -4 : -5);
                    }
                },
                third: {
                    label: "3rd attack",
                    callback: () => {
                        skillRollWithMAP(action.multipleAttackPenalty === "agile" ? -8 : -10);
                    }
                }
            },
            default: "first",
